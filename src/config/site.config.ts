/**
 * Single source of truth for a prospect preview site.
 * Edit this file (or run `npm run new-preview`) to rebrand for a new firm.
...
const config: SiteConfig = {
  ...
  hero: {
    ...
    subheadline:
      'Harbour Tax & Advisory helps local owners, investors and growing teams with tax, BAS, and practical advice you can act on. Based in Cleveland, serving Redland City and greater SEQ.',
  ...
  about: {
    intro:
      'Harbour Tax & Advisory is a Cleveland-based practice built for owners who want straightforward tax and reporting without the corporate runaround.',
    paragraphs: [
  ...
  services: [
    {
      ...
      summary:
        'Accurate lodgement for sole traders, companies, trusts and SMSFs, with plain-English summaries of what you owe and why.',
      details: [
    ...
    },
    {
      ...
      summary:
        'Quarterly BAS, STP payroll and super reconciliations so cash flow and compliance stay aligned through the year.',
      details: [
    ...
    },
    {
      ...
      summary:
        'Clean books in Xero or MYOB — chart of accounts, bank feeds, and month-end routines that make reporting usable.',
      details: [
    ...
    },
    {
      ...
      summary:
        'Cash flow, pricing and structure conversations before the decision — so tax is a factor, not a surprise.',
      details: [
  ...
  seo: {
    ...
    defaultDescription:
      'Cleveland accountants for tax returns, BAS, bookkeeping and practical business advice. Serving Redland City and South East Queensland.',
  },
  // Replace with your Formspree form ID: https://formspree.io/
  // Until then, the contact page also offers a mailto fallback.
